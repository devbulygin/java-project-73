...
//    }
    ...
    public void updateUser() throws Exception {
        ...
        assertEquals(null, userRepository.findByEmail(TEST_EMAIL).orElse(null));
    ...
    public void deleteUser() throws Exception {
        ...
        utils.perform(delete(fullPath + ID, userId), TEST_EMAIL)
                .andExpect(status().isOk());
    ...
    public void deleteUserFails() throws Exception {
        ...
        utils.perform(delete(fullPath + ID, userId), TEST_EMAIL_2)
